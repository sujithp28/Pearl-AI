...
from src.agent.execution_model import (
    ExecutionReport,
    ExecutionStep,
    ProgressEvent,
    ProgressStatus,
...
# The execution data model now lives in `execution_model.py`. It is
# re-exported here because `from src.agent.executor import ExecutionReport`
# is the import every caller and test already uses, and moving a type is
...
class AutonomousExecutor:
    ...
    def __init__(
        ...
        # Set by run(); read by _finish_or_pause for LLM reflection.
