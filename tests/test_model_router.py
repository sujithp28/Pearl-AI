...
class TestEffectiveProvider:
    ...
    def test_returns_chat_provider_when_set(self, monkeypatch: pytest.MonkeyPatch) -> None:
...
class TestModelRouter:
    def test_client_for_returns_llm_client(self, monkeypatch: pytest.MonkeyPatch) -> None:
        monkeypatch.setattr("src.llm.router.Settings.PLANNING_PROVIDER", "")
    ...
    def test_client_for_caches_on_second_call(self, monkeypatch: pytest.MonkeyPatch) -> None:
        monkeypatch.setattr("src.llm.router.Settings.PLANNING_PROVIDER", "")
        monkeypatch.setattr("src.llm.router.Settings.PLANNING_MODEL", "")
    ...
    def test_planning_client_delegates_to_client_for(self, monkeypatch: pytest.MonkeyPatch) -> None:
        monkeypatch.setattr("src.llm.router.Settings.PLANNING_PROVIDER", "")
        monkeypatch.setattr("src.llm.router.Settings.PLANNING_MODEL", "")
    ...
    def test_chat_client_delegates_to_client_for(self, monkeypatch: pytest.MonkeyPatch) -> None:
        monkeypatch.setattr("src.llm.router.Settings.CHAT_PROVIDER", "")
        monkeypatch.setattr("src.llm.router.Settings.CHAT_MODEL", "")
    ...
    def test_all_same_provider_true_when_no_overrides(self, monkeypatch: pytest.MonkeyPatch) -> None:
        monkeypatch.setattr("src.llm.router.Settings.PLANNING_PROVIDER", "")
        monkeypatch.setattr("src.llm.router.Settings.CHAT_PROVIDER", "")
        monkeypatch.setattr("src.llm.router.Settings.PLANNING_MODEL", "")
        monkeypatch.setattr("src.llm.router.Settings.CHAT_MODEL", "")
...
class TestMCPServerChatLlm:
    def test_chat_uses_chat_llm_when_provided(self) -> None:
        ...
        request = JsonRpcRequest(
            id=1, method="pearl/chat", params={"message": "hi"}
        )
